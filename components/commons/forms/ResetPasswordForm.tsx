...
const ResetPasswordForm = () => {
    ...
    async function resetPassword({ email }: z.infer<typeof formSchema>) {
        setIsLoading(true)
        setSuccessMessage("")
        setErrorMessage("")
        ...
        try {
            const { data, error } = await authClient.requestPasswordReset({
                email: email,
                redirectTo: `${window.location.origin}/account/reset-password`, // URL de redirection après clic dans l'email
            })
